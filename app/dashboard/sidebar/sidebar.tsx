const Sidebar = () => {
    return (
            ...
            <div className="h-screen flex">
                <aside
                    className="flex flex-col items-center bg-white text-gray-700 shadow bg-gray-200 transition-all duration-300 ease-in-out">
                    ...
                    <div className="mt-auto h-16 bottom-0 flex flex-row items-center w-full focus:text-orange-500 hover:bg-red-200 focus:outline-none border-t-indigo-500">
                        <div>
                            <button
                                className="h-16 w-10 mx-3 flex flex justify-center items-center">
                                <svg
